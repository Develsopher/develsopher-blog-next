---
title: 'javascript Set & Map'
description: javascript Set & Map에 대해 알아봅니다.
image: '../../public/blogs/hero/hero-javascript-set-map.png'
...
- `Array.prototype.forEach`메서드의 콜백 함수 : 두번째 인수로 현재 순회 중인 요소의 인덱스를 전달받는다. - `Set` 객체는 순서에 의미가 없기에 배열과 같이 인덱스를 가지지 않는다.
