...
description: network REST API에 대해 알아봅니다.
image: '../../public/blogs/hero/network-restapi.png'
...
- 목적지를 추가해야한다.
  ...
  ![REST API](https://develsopher-nextjs.s3.ap-northeast-2.amazonaws.com/REST+API-1.png)
...
- 어떤 문법으로 작성되어있는지 알아야하므로 컨텐트 타입을 넣어주어야한다.
  ...
  ![REST API](https://develsopher-nextjs.s3.ap-northeast-2.amazonaws.com/REST+API-2.png)
...
![REST API](https://develsopher-nextjs.s3.ap-northeast-2.amazonaws.com/REST+API-3.png)

이미지 출처 : [https://www.youtube.com/watch?v=RP_f5dMoHFc](https://www.youtube.com/watch?v=RP_f5dMoHFc)

이처럼 Hyperlink를 클릭해 링크를 따라가면서 전이 되었기 때문에 이것은 HATEOAS가 되었다.

![REST API](https://develsopher-nextjs.s3.ap-northeast-2.amazonaws.com/REST+API-4.png)
