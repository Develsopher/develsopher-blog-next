...
export const allBlogs = [automatingRepetitiveTasksProductivityHacksForDevelopers__indexMdx, jsFrameworksComparison__indexMdx, bestPracticesForWritingCleanAndMaintainableCode__indexMdx, buildingProgressiveWebAppsBridgingTheGapBetweenWebAndMobile__indexMdx, mindfulnessAndMeditationTechniquesForDevelopersImprovingFocusAndClarity__indexMdx, masteringCssGridLayout__indexMdx, restfulApisBuildingBlocks__indexMdx, webAccessibilityBestPractices__indexMdx, progressiveWebAppsPwa__indexMdx, webAccessibilityInclusiveDesign__indexMdx, webDevelopmentToolsProductivity__indexMdx]
